...
class ModelLoader(sciunit.Model,
    ...
    def __init__(self, name="model", mod_files_path=None):
        ...
        self.c_minmax = numpy.array([0.0004, 0.004])
        ...
        self.dend_loc = [['dendrite[15]', 0.5], ['dendrite[15]',0.8333333333333334], ['dendrite[28]', 0.3], ['dendrite[28]', 0.7], ['dendrite[29]', 0.3], ['dendrite[29]', 0.5], ['dendrite[32]', 0.9], ['dendrite[32]', 0.8333333333333334], ['dendrite[52]', 0.3], ['dendrite[52]', 0.5], ['dendrite[53]', 0.5], ['dendrite[54]', 0.5], ['dendrite[74]', 0.5], ['dendrite[74]', 0.8333333333333334], ['dendrite[79]', 0.3], ['dendrite[79]', 0.5], ['dendrite[80]', 0.3], ['dendrite[80]', 0.5], ['dendrite[82]', 0.3], ['dendrite[82]', 0.7], ['dendrite[84]', 0.3], ['dendrite[84]', 0.5]]
        self.dend_locations = collections.OrderedDict()
        self.NMDA_name = 'NMDA_L'
        self.default_NMDA_name = 'NMDA_L'
        self.default_NMDA_path = pkg_resources.resource_filename("hippounit", "tests/Luca_nmda/")

        self.AMPA_name = None
        self.AMPA_NMDA_ratio = 0.5
        
        self.SC_AMPA_NMDA_ratio = 0.5
        self.PP_AMPA_NMDA_ratio = 0.3
