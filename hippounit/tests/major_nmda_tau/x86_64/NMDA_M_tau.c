...
#define nrn_init _nrn_init__NMDA_M_tau
#define _nrn_initial _nrn_initial__NMDA_M_tau
#define nrn_cur _nrn_cur__NMDA_M_tau
#define _nrn_current _nrn_current__NMDA_M_tau
#define nrn_jacob _nrn_jacob__NMDA_M_tau
#define nrn_state _nrn_state__NMDA_M_tau
#define _net_receive _net_receive__NMDA_M_tau 
#define state state__NMDA_M_tau 
...
#define _f_mgblock _f_mgblock_NMDA_M_tau
#define mgblock mgblock_NMDA_M_tau
...
#define usetable usetable_NMDA_M_tau
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_NMDA_M_tau", 0, 1,
 0,0,0
};
 ...
 "usetable_NMDA_M_tau", &usetable_NMDA_M_tau,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_M_tau /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/major_nmda_tau/NMDA_M_tau.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/major_nmda_tau/NMDA_M_tau.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
