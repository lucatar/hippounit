...
#define nrn_init _nrn_init__NMDA_CA1_pyr_SC_2_comp_Magee
#define _nrn_initial _nrn_initial__NMDA_CA1_pyr_SC_2_comp_Magee
#define nrn_cur _nrn_cur__NMDA_CA1_pyr_SC_2_comp_Magee
#define _nrn_current _nrn_current__NMDA_CA1_pyr_SC_2_comp_Magee
#define nrn_jacob _nrn_jacob__NMDA_CA1_pyr_SC_2_comp_Magee
#define nrn_state _nrn_state__NMDA_CA1_pyr_SC_2_comp_Magee
#define _net_receive _net_receive__NMDA_CA1_pyr_SC_2_comp_Magee 
#define state state__NMDA_CA1_pyr_SC_2_comp_Magee 
...
#define _f_mgblock _f_mgblock_NMDA_CA1_pyr_SC_2_comp_Magee
#define mgblock mgblock_NMDA_CA1_pyr_SC_2_comp_Magee
...
#define fastRate fastRate_NMDA_CA1_pyr_SC_2_comp_Magee
 double fastRate = 0.61;
#define tau2slow tau2slow_NMDA_CA1_pyr_SC_2_comp_Magee
 double tau2slow = 878.3;
#define usetable usetable_NMDA_CA1_pyr_SC_2_comp_Magee
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2slow_NMDA_CA1_pyr_SC_2_comp_Magee", 1e-09, 1e+09,
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_NMDA_CA1_pyr_SC_2_comp_Magee", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "tau2slow_NMDA_CA1_pyr_SC_2_comp_Magee", "ms",
 "tau1", "ms",
 "tau2", "ms",
 "e", "mV",
 "mg", "mM",
 ...
 "tau2slow_NMDA_CA1_pyr_SC_2_comp_Magee", &tau2slow_NMDA_CA1_pyr_SC_2_comp_Magee,
 "fastRate_NMDA_CA1_pyr_SC_2_comp_Magee", &fastRate_NMDA_CA1_pyr_SC_2_comp_Magee,
 "usetable_NMDA_CA1_pyr_SC_2_comp_Magee", &usetable_NMDA_CA1_pyr_SC_2_comp_Magee,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _NMDA_CA1_pyr_SC_2_comp_Magee_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_CA1_pyr_SC_2_comp_Magee /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Magee_NMDAr/NMDA_CA1_pyr_SC_2_comp_Magee.mod\n");
...
/*CVODE*/
 ...
 static int state (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
    ...
    C = C + (1. - exp(dt*(( - 1.0 ) / tau2slow)))*(- ( 0.0 ) / ( ( - 1.0 ) / tau2slow ) - C) ;
   }
  return 0;
}
 ...
 B = B + _args[0] * factor ;
   ...
   if (nrn_netrec_state_adjust && !cvode_active_){
    ...
    double __primary = (C + _args[0] * factor) - __state;
     __primary += ( 1. - exp( 0.5*dt*( ( - 1.0 ) / tau2slow ) ) )*( - ( 0.0 ) / ( ( - 1.0 ) / tau2slow ) - __primary );
    C += __primary;
  } else {
 C = C + _args[0] * factor ;
     }
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 ...
 if ( tau1 / tau2 > .9999 ) {
   ...
   B = 0.0 ;
   C = 0.0 ;
   _ltau2comp = fastRate * tau2 + ( 1.0 - fastRate ) * tau2slow ;
   _ltp = ( tau1 * _ltau2comp ) / ( _ltau2comp - tau1 ) * log ( _ltau2comp / tau1 ) ;
   factor = - exp ( - _ltp / tau1 ) + exp ( - _ltp / _ltau2comp ) ;
   factor = 1.0 / factor ;
   }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = ( ( fastRate * B + ( 1.0 - fastRate ) * C ) - A ) * mgblock ( _threadargscomma_ v ) ;
   i = g * ( v - e ) * ( 1.0 - pf ) ;
   ica = g * ( v - eca ) * pf ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Magee_NMDAr/NMDA_CA1_pyr_SC_2_comp_Magee.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "\n"
  "Paramteres from Andasfalvy & Magee 2001.: tau1 = 6.46, tau2 = 252.5 tau2_slow = 1660 originally, after q10 correction: tau1 = 2.51, tau2 = 133.6 tau2_slow = 878.3\n"
  "\n"
  "  \n"
  "ENDCOMMENT\n"
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS NMDA_CA1_pyr_SC_2_comp_Magee\n"
  ...
  "\n"
  "PARAMETER {\n"
  "	tau1= 2.51 (ms) <1e-9,1e9>\n"
  "	tau2 = 133.6 (ms) <1e-9,1e9>\n"
  "	tau2slow = 878.3 (ms) <1e-9,1e9>\n"
  "	fastRate = 0.61\n"
  "	e=0	(mV)\n"
