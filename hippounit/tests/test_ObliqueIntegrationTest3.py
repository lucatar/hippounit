...
class ObliqueIntegrationTest3(Test):
    """
    ...
    def binsearch(self, model, counter, dend_loc0):
        ...
        if self.force_run_bin_search or (os.path.isfile(file_name) is False):
            ...
            while c_step_start >= c_step_stop and not found:
                ...
                num = [self.threshold_index - 1,self.threshold_index, self.threshold_index + 1]   # [4,5]
                ...
                if found:
                    if result[1][2]>=1 or result[2][2]>=1:            # somatic AP is generated
                        found = None
                        break
            ...
            binsearch_result=[found, c_stim[midpoint], counter]
    ...
    def generate_prediction(self, model, verbose=False):
        ...
        counter = 0
        binsearch_ = functools.partial(self.binsearch, model, counter)
        ...
        for i in range(0, len(model.dend_loc)):
            print('Iteration until weight is found:', results0[i][2])
