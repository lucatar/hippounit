...
#define nrn_init _nrn_init__Otmakhova_nmda
#define _nrn_initial _nrn_initial__Otmakhova_nmda
#define nrn_cur _nrn_cur__Otmakhova_nmda
#define _nrn_current _nrn_current__Otmakhova_nmda
#define nrn_jacob _nrn_jacob__Otmakhova_nmda
#define nrn_state _nrn_state__Otmakhova_nmda
#define _net_receive _net_receive__Otmakhova_nmda 
#define state state__Otmakhova_nmda 
...
#define icc _p[7]
#define icc_columnindex 7
#define g _p[8]
#define g_columnindex 8
#define mgfactor _p[9]
#define mgfactor_columnindex 9
#define A _p[10]
...
#define _f_mgblock _f_mgblock_Otmakhova_nmda
#define mgblock mgblock_Otmakhova_nmda
...
#define usetable usetable_Otmakhova_nmda
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_Otmakhova_nmda", 0, 1,
 0,0,0
};
 ...
 "usetable_Otmakhova_nmda", &usetable_Otmakhova_nmda,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Otmakhova_nmda /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/othmakova_nmda/exp2synNMDA.mod\n");
...
double _f_mgblock ( _threadargsprotocomma_ double _lv ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.1 * - _lv ) * ( mg / 15.0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/othmakova_nmda/exp2synNMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
