...
#define nrn_init _nrn_init__NMDA_L
#define _nrn_initial _nrn_initial__NMDA_L
#define nrn_cur _nrn_cur__NMDA_L
#define _nrn_current _nrn_current__NMDA_L
#define nrn_jacob _nrn_jacob__NMDA_L
#define nrn_state _nrn_state__NMDA_L
#define _net_receive _net_receive__NMDA_L 
#define state state__NMDA_L 
...
#define vhalf _p[5]
#define vhalf_columnindex 5
#define k0 _p[6]
#define k0_columnindex 6
#define i _p[7]
#define i_columnindex 7
#define icc _p[8]
#define icc_columnindex 8
#define g _p[9]
...
#define _f_mgblock _f_mgblock_NMDA_L
#define mgblock mgblock_NMDA_L
...
#define usetable usetable_NMDA_L
 double usetable = 1;
 ...
 "usetable_NMDA_L", &usetable_NMDA_L,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_L /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Luca_jatszik_nmda/NMDA_L.mod\n");
...
double _f_mgblock ( _threadargsprotocomma_ double _lv ) {
 ...
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.08 * - _lv ) * ( mg / 5.0 ) ) ;
   _lmgblock = 1.0 / ( 1.0 + exp ( ( - _lv - vhalf ) / k0 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Luca_jatszik_nmda/NMDA_L.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
