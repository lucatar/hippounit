...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_CA1_pyr_SC /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Playing_nmda/NMDA_CA1_pyr_SC.mod\n");
...
double _f_mgblock ( _threadargsprotocomma_ double _lv ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.150 * - _lv ) * ( mg / 3.57 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/Playing_nmda/NMDA_CA1_pyr_SC.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "\n"
  "	: from Jahr & Stevens\n"
  "	mgblock = 1 / (1 + exp(0.150 (/mV) * -v) * (mg / 3.57 (mM)))\n"
  "\n"
  "}\n"
  "\n"
