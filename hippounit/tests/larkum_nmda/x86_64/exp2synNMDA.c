...
#define nrn_init _nrn_init__NMDA_larkum
#define _nrn_initial _nrn_initial__NMDA_larkum
#define nrn_cur _nrn_cur__NMDA_larkum
#define _nrn_current _nrn_current__NMDA_larkum
#define nrn_jacob _nrn_jacob__NMDA_larkum
#define nrn_state _nrn_state__NMDA_larkum
#define _net_receive _net_receive__NMDA_larkum 
#define state state__NMDA_larkum 
...
#define _f_mgblock _f_mgblock_NMDA_larkum
#define mgblock mgblock_NMDA_larkum
...
#define usetable usetable_NMDA_larkum
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_NMDA_larkum", 0, 1,
 0,0,0
};
 ...
 "usetable_NMDA_larkum", &usetable_NMDA_larkum,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_larkum /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/larkum_nmda/exp2synNMDA.mod\n");
...
double _f_mgblock ( _threadargsprotocomma_ double _lv ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.08 * - _lv ) * ( mg * 0.3 ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/larkum_nmda/exp2synNMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
