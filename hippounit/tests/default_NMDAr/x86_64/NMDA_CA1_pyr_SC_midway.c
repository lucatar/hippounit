...
#define nrn_init _nrn_init__NMDA_CA1_pyr_SC_midway
#define _nrn_initial _nrn_initial__NMDA_CA1_pyr_SC_midway
#define nrn_cur _nrn_cur__NMDA_CA1_pyr_SC_midway
#define _nrn_current _nrn_current__NMDA_CA1_pyr_SC_midway
#define nrn_jacob _nrn_jacob__NMDA_CA1_pyr_SC_midway
#define nrn_state _nrn_state__NMDA_CA1_pyr_SC_midway
#define _net_receive _net_receive__NMDA_CA1_pyr_SC_midway 
#define state state__NMDA_CA1_pyr_SC_midway 
...
#define _f_mgblock _f_mgblock_NMDA_CA1_pyr_SC_midway
#define mgblock mgblock_NMDA_CA1_pyr_SC_midway
...
#define usetable usetable_NMDA_CA1_pyr_SC_midway
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 "usetable_NMDA_CA1_pyr_SC_midway", 0, 1,
 0,0,0
};
 ...
 "usetable_NMDA_CA1_pyr_SC_midway", &usetable_NMDA_CA1_pyr_SC_midway,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _NMDA_CA1_pyr_SC_midway_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("ca", -10000.);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NMDA_CA1_pyr_SC_midway /home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/default_NMDAr/NMDA_CA1_pyr_SC_midway.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/tarluca/Modellke_story/hippounit_Spine_project_20221102/hippounit/hippounit/tests/default_NMDAr/NMDA_CA1_pyr_SC_midway.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  ...
  "\n"
  "NEURON {\n"
  "	POINT_PROCESS NMDA_CA1_pyr_SC_midway\n"
