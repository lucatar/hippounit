...
def run_test(ind_and_params):
    ...
    # Load target data
    """Edit the line below"""
    with open('./target_features/feat_backpropagating_AP_target_data_ratio.json') as f:
    ...
    test = tests.BackpropagatingAPTest2(observation = observation, config=config, save_all = True, force_run=False, force_run_FindCurrentStim=False, show_plot = True, base_directory = base_directory)
