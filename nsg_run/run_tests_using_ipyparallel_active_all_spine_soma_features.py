...
def main(i):
    ...
    os.system('python3 run_hippounit_test_active_all_spine_soma_features.py ' + str(i))
...
if __name__ == '__main__':
    ...
    #default_NMDA_path = pkg_resources.resource_filename("hippounit", "tests/major_nmda/")
