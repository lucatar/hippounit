...
def run_test(ind_and_params):
    ...
    test = tests.BackpropagatingAPTest(observation = observation, config=config, save_all = True, force_run=False, force_run_FindCurrentStim=False, show_plot = True, base_directory = base_directory)
