...
def run_test(ind_and_params):
    ...
    model.c_step_start = 0.0004
    model.c_step_stop = 0.000004
    model.c_minmax = numpy.array([0.00004, 0.004])
    ...
    test = tests.ObliqueIntegrationTest2(observation = observation, save_all = True, force_run_synapse=False, force_run_bin_search=False, show_plot = False, base_directory = base_directory)
...
def create_params_list():
    ...
    """Edit the line below"""
    f = open('./last_lefutott3_model.csv')
    lines = []
