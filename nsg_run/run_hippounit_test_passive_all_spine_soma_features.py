...
def run_test(ind_and_params):
    ...
    # user function path
    """Edit the line below"""
    user_function_path = './usr_fun_model_full_for_allspine.txt'
    ...
    """Edit the line below"""
    model.hocpath = "./model/load_model_na_inhomo_minimal_model_full_soma_all_spine_true_diam_passive_KA_fact.hoc"
    ...
    """Edit the line below"""
    base_directory = './Passive_all_spine/'

    # Load target data
    """Edit the line below"""
    with open('./target_features/valid_feat_rat_CA1_JMakara_OUR_features.json') as f:
